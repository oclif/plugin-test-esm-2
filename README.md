...
running command...
$ esm2 (--version)
@oclif/plugin-test-esm-2/0.7.33 linux-x64 node-v18.20.4
$ esm2 --help [COMMAND]
USAGE
  $ esm2 COMMAND
...
...
_See code: [src/commands/esm2.ts](https://github.com/oclif/plugin-test-esm-2/blob/0.7.33/src/commands/esm2.ts)_
