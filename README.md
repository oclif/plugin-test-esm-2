...
running command...
$ esm2 (--version)
@oclif/plugin-test-esm-2/0.7.15 linux-x64 node-v18.20.3
$ esm2 --help [COMMAND]
USAGE
  $ esm2 COMMAND
...
...
_See code: [src/commands/esm2.ts](https://github.com/oclif/plugin-test-esm-2/blob/0.7.15/src/commands/esm2.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/5.3.5/src/commands/plugins/index.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/5.3.5/src/commands/plugins/inspect.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/5.3.5/src/commands/plugins/install.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/5.3.5/src/commands/plugins/link.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/5.3.5/src/commands/plugins/reset.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/5.3.5/src/commands/plugins/uninstall.ts)_
...
_See code: [@oclif/plugin-plugins](https://github.com/oclif/plugin-plugins/blob/5.3.5/src/commands/plugins/update.ts)_
<!-- commandsstop -->
